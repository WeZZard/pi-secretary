...
| [Fleet cancellation shortcuts](../.plans/2026-09-20-fleet-cancellation-ui.md) | It records visible selected-agent and fleet-wide stop shortcuts, captured-run confirmation, and batch cancellation verification. |
| [Model inheritance investigation](research/subagent-model-inheritance.md) | It explains the recorded definition override and verifies current-model inheritance through real SDK sessions without changing model-selection precedence. |
| [Model inheritance investigation plan](../.plans/2026-09-20-subagent-model-inheritance-investigation.md) | It records the controlled configuration experiment, unchanged runtime, and verification limits. |
...
| [Session rewind repair plan](../.plans/2026-09-20-subagent-session-rewind.md) | It records the implemented branch-aware visibility, admission-scoped identities, and cancellation of abandoned work. |
| [Fleet overlay geometry repair](../.plans/2026-09-20-fleet-overlay-geometry.md) | It records the stable frame sizing, complete borders, pane proportions, and terminal-cell regression strategy. |
